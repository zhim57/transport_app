...
// working function #2
  ...
  return (
    <div className="row">
      {tasks.map((task) => (
        <div key= {task.taskStartPoint} className="col-sm-9 mx-auto col-md-6 col-lg-3 my-3">  
          {/* {console.log(task)} */}
          <div className="card">
            {/* <taskConsumer> */}
            {/* <tasks> */}
            ...
            <div className="card-footer d-flex justify-content-between">
              <p className="align-serl-center mb-0">{task.taskName}</p>
              <h5 className="text-blue font-italic mb-0">
                <span className="mr-1">${task.peopleCount}</span>
              </h5>
            </div>
          </div>
        </div>
