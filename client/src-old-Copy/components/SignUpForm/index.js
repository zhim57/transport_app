...
function SignUpForm(props) {
    ...
    const handleSubmit = event => {
        ...
        if(passwordVal.validate(passwordInput.current.value)){
            ...
            API.signup({ email: emailInput.current.value, password: passwordInput.current.value, username: nameInput.current.value, role: roleInput.current.value })
            .then(data => {
                ...
                console.log(passwordInput.current.value);
                console.log("role"+ UserContext.role +"logged in:" + loggedIn +"e mail"+ email)
                    ...
                    return (<form {...extraProps} onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" ref={roleInput} type="text" id={roleId} size="3" >
                                ...
                                <option type="text" ref={roleInput} value="dispatcher">Dispatcher</option>
                            </select>
